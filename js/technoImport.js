...
const text = ["Three.js est une bibliothèque JavaScript open source qui permet de créer et de visualiser des modèles 3D dans un navigateur web. " +
                        "Three.js nous permet également d'intégrer des animations 3d à nos sites web.",
                        ...
                        "Pour la créaation d'application Android Studio nous laisse le choix entre les languages de programmation Kotlin et Java et pour la mise en page, il nous propose l'utilisation de XML.",
